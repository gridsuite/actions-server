...
public class IdBasedContingencyList extends AbstractContingencyList {
    ...
    public IdBasedContingencyList(UUID uuid, OffsetDateTime date, IdentifierContingencyList identifierContingencyList) {
        this(uuid, date, identifierContingencyList, Map.of());
    }

    public IdBasedContingencyList(UUID uuid, OffsetDateTime date, IdentifierContingencyList identifierContingencyList, Map<String, Set<String>> notFoundElements) {
